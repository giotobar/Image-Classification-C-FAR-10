...
class SVM(object):
  ...
  def loss(self, X, y):
    ...
    # ================================================================ #
        ...
        correction = score[y[i]]
        
        for n in np.arange(num_classes):
            if n == y[i]:
                continue
            marg = score[n] -correction +1
  ...
  def fast_loss_and_grad(self, X, y):
    ...
    correction = score[np.arange(num_train),y].reshape((num_train,-1))
    
    marg = np.maximum(0,score-correction+1)
    
    marg[np.arange(num_train),y]=0
    loss = np.sum(marg) 
    loss /= num_train
    # ================================================================ #
    # END YOUR CODE HERE
    ...
    # ================================================================ #
    marg[marg>0]=1
    rows = -np.sum(marg,axis=1)
    marg[np.arange(num_train),y]= rows
    grad =np.dot(marg.T,X)
    grad /=num_train
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
